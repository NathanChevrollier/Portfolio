...
<head>
  ...
  <title>Réalisations en alternance - My Micro</title>
  <meta content="Présentation des projets et missions réalisés en alternance chez My Micro" name="description">
  <meta content="alternance, BTS SIO, My Micro, projets, compétences" name="keywords">
    ...
    <div id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <h2 class="portfolio-title">Réalisations en alternance - My Micro</h2>
